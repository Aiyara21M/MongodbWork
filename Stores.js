...
{$match:{
    statusflag:"A",
    storeuid:ObjectId("64ad01c93337c300758c0a9b")
    }},
      ...
      { $unwind: { path: "$itemmasters", preserveNullAndEmptyArrays: true } },
      	{ $match: { "itemmasters.handlingstores.storeuid":  ObjectId("64ad01c93337c300758c0a9b") } },
      {
        $addFields: {
          requestuids: {
            $map: {
