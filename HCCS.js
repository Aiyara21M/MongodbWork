db.getCollection("patientvisits").aggregate([
 {
        $match: {
            createdat: {
               $gte: ISODate("2024-07-02T00:00:00.000+07:00"),
                $lte: ISODate("2024-07-02T23:59:59.999+07:00")
            },
        }
    },
  ...
  { $unwind: { path: "$status2", preserveNullAndEmptyArrays: true } },
    ...
    { $lookup: { from: "payors", localField: "bill.payoruid", foreignField: "_id", as: "payor" } },
